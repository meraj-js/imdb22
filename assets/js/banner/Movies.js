async function AboutMovies() {
    try {
    let data = await fetch("https://p-nouri004.github.io/IMDb-db/db.json")
    let res = await data.json()
    let movies = res.aboutmovies.map(function (elem) {
        return`
            <div class="movie-part">
                        <img src="${elem.movieurl}" alt="${elem.moviealt}">
                        <div class="info">
                            <div class="play">
                            ...
                            <span class="sc-ed60be29-10 ftsGBD">${elem.title}</span>
                            <span class="sc-ed60be29-11 fAnuin reactions">${elem.description}</span>
                            <div class="likes">
        ...
        document.querySelector(".about-movies .movies").insertAdjacentHTML("afterbegin",movies.join(""))
    } catch (error) {
