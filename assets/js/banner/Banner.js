async function Banner() {
    try {
        ...
        let banner = res.banner.map(function(elem){
            return`
                <div class="swiper-slide">
                    <img src="${elem.bannerurl}" alt="${elem.banneralt}">
                    <div class="shadow"></div>
                    <div class="poster">
                        <img
                            src="${elem.pasterurl}" alt="${elem.posteralt}">
                    ...
                    <div class="poster-info-left"><svg version="1.1" id="Layer_1"
                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        width="80px" height="80px" viewBox="0 0 32 32" enable-background="new 0 0 32 32"
                    ...
                    <div class="poster-info-right">
                        <div class="title">
                            <h3>${elem.title}</h3>
                            <span>${elem.time}</span>
                        </div>
                        <span>${elem.description}</span>
                        <div class="likes-first">
        ...
        document.querySelector(".page-content-container .swiper-wrapper").insertAdjacentHTML("afterbegin",banner.join(""))
