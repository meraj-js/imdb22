async function Fanfavorites() {
    try {
        let data = await fetch("https://p-nouri004.github.io/IMDb-db/db.json")
        let res = await data.json()
        let fanfavorites = res.fanfavorites.map(function(elem) {
            return`
                <div class="swiper-slide">
                    <img src="${elem.fanfavoritesurl}"
                            alt="${elem.fanfavoritesalt}">
        ...
        document.querySelector(".fan-favorites .swiper-wrapper").insertAdjacentHTML("afterbegin",fanfavorites.join(""))
