async function Originals() {
    try {
        ...
        let originals = res.originals.map(function(elem){
            return`
                <div class="swiper-slide">
                    <div class="original-image">
                        <img src="${elem.originalurl}"
                            alt="${elem.originalalt}">
                        <div class="view">
                            <svg fill="#ffffff" width="30px" height="30px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff" stroke-width="0.00024000000000000003"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#CCCCCC" stroke-width="0.624"></g><g id="SVGRepo_iconCarrier"><path d="M12,1A11,11,0,1,0,23,12,11.013,11.013,0,0,0,12,1Zm0,20a9,9,0,1,1,9-9A9.011,9.011,0,0,1,12,21ZM10,8l6,4-6,4Z"></path></g></svg>
                            <span>${elem.time}</span>
                        </div>
        ...
        document.querySelector(".Exclusive-videos .swiper-wrapper").insertAdjacentHTML("afterbegin",originals.join(""))
        
    } catch (error) {
        console.log(error.message);
    }

    var swiper = new Swiper(".Originals", {
            slidesPerView: 1,
