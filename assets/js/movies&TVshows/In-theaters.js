async function intheaters() {
    try {
        ...
        let intheaters = res.intheaters.map(function (elem) {
            return`
                <div class="swiper-slide">
                            <img src="${elem.intheatersurl}" alt="${elem.intheatersalt}">
                            ...
                            <button><svg width="20px" height="20px" viewBox="0 0 28 28" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                    <g id="SVGRepo_iconCarrier">
        ...
        document.querySelector(".Movies-TVshows .swiper-wrapper").insertAdjacentHTML("afterbegin",intheaters.join(""))
        
    } catch (error) {
        console.log(error.message);
    }

    var swiper = new Swiper(".theaters", {
      slidesPerView: 1,
      spaceBetween: 10,
      navigation: {
