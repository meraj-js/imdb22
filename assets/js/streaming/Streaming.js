async function Streaming() {
    try {
        ...
        let streaming = res.streaming.map(function(elem) {
            return`
                <div class="swiper-slide">
                    <img src="${elem.fanfavoritesurl}" alt="${elem.fanfavoritesalt}">
                        <div class="wathing-more">
                            <svg width="52px" height="48px" viewBox="2 3 46 46" xmlns="http://www.w3.org/2000/svg"><title>70 Basic icons by Xicons.co</title><path d="M36.8,47.6L24,38,11.2,47.6A2,2,0,0,1,8,46V3a2,2,0,0,1,2-2H38a2,2,0,0,1,2,2V46A2,2,0,0,1,36.8,47.6Z" fill=" rgb(104, 105, 110,0.7)"/><path d="M29.05,22H18.95a2,2,0,0,1,0-4H29.05A2,2,0,0,1,29.05,22Z" fill="#ffffff"/><path d="M26,14.95V25.05a2,2,0,0,1-4,0V14.95A2,2,0,0,1,26,14.95Z" fill="#ffffff"/></svg>
                        </div>
                        ...
                        <div class="stars">
                            ...
                            <span>${elem.ranking}</span>
                            <svg fill="rgb(84,146,228)" width="20px" height="20px" viewBox="0 0 24 24" id="star"
                                ...
                                <g id="SVGRepo_iconCarrier">
                                    <polygon id="primary"
                                        ...
                                        style="fill: none; stroke: rgb(84,146,228); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;">
                                    </polygon>
                                </g>
                            </svg>
                        </div>
                        <span>${elem.title}</span>
                        <button>${elem.watchlist}<svg fill="rgb(87, 153, 239)" width="20px" height="20px" viewBox="0 0 512 512" data-name="Layer 1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" stroke="rgb(87, 153, 239)"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M421.24,269.93h30V429.84a48.72,48.72,0,0,1-48.66,48.66H82.77a48.72,48.72,0,0,1-48.66-48.66V110A48.72,48.72,0,0,1,82.77,61.37H242.68v30H82.77A18.68,18.68,0,0,0,64.11,110V429.84A18.68,18.68,0,0,0,82.77,448.5H402.58a18.68,18.68,0,0,0,18.66-18.66Zm-69-236.43v30h74.4L249.5,240.68l21.21,21.21L447.89,84.71v74.4h30V33.5Z"></path></g></svg></button>
                        <div class="trailer">
        ...
        document.querySelector(".streaming .swiper-wrapper").insertAdjacentHTML("afterbegin",streaming.join(""))
        
    } catch (error) {
        console.log(error.message);
    }

    var swiper = new Swiper(".streaming-slide", {
      slidesPerView: 1,
      spaceBetween: 10,
      navigation: {
