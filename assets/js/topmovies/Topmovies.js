async function Topmovies() {
    try {
        ...
        let topmovies = res.Top10.map(function (elem) {
            return `
                <div class="swiper-slide">
                    <img src="${elem.topMovieurl}"
                        alt="${elem.topmoviealt}">
                    ...
                    <button><svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 12H20M12 4V20" stroke="rgb(63,153,239)" stroke-width="1.8240000000000003" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>${elem.watchlist}</button>
                    <div class="trailer">
        ...
        document.querySelector(".top-movies .swiper-wrapper").insertAdjacentHTML("afterbegin", topmovies.join(""))

    } catch (error) {
        console.log(error.message);
    }

    var swiper = new Swiper(".top-movies-line", {
        slidesPerView: 1,
        slidesPerGroup: 2,
        spaceBetween: 10,
        navigation: {
